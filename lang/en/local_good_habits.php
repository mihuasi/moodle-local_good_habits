...
$string['xlabel'] = 'Dedication';
$string['ylabel'] = 'Outcome';
$string['x_small_label_left'] = 'Lax';
$string['x_small_label_center'] = 'Reasonable effort';
$string['x_small_label_right'] = 'Vigorous effort';
$string['y_small_label_bottom'] = 'Disappointing';
$string['y_small_label_center'] = 'Reasonable';
$string['y_small_label_top'] = 'Outstanding';
$string['x_select_label'] = 'Dedication';
$string['y_select_label'] = 'Outcome';
$string['x_default'] = 'Select';
$string['y_default'] = 'Select';
$string['overlay_1_1'] = 'Instinctually mastering';
$string['overlay_1_2'] = 'Earning your mastery';
$string['overlay_1_3'] = 'Working hard for mastery';
$string['overlay_2_1'] = 'Laid back competence';
